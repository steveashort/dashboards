...
assert.strictEqual(calculateTrackerSize({ type: 'gauge' }), '1x1', 'Gauge should be 1x1');
assert.strictEqual(calculateTrackerSize({ type: 'rag' }), '1x1', 'RAG should be 1x1');
assert.strictEqual(calculateTrackerSize({ type: 'counter' }), '1x1', 'Counter should be 1x1');
